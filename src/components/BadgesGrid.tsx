...
import { 
  Award, Shield, Flame, Brain, Clock, Lock, Sparkles
} from 'lucide-react';
...
export const BadgesGrid: React.FC<BadgesGridProps> = ({ unlockedIds = [] }) => {
  ...
  return (
    <div className="bg-white border-2 border-[#292524] rounded-2xl p-5 shadow-[4px_4px_0px_#292524] text-[#292524] text-left space-y-4" id="badges-achievements-panel">
      {/* Header */}
      <div className="flex items-center justify-between border-b border-[#292524]/10 pb-3">
        <div className="space-y-0.5">
          <h3 className="font-serif font-black text-sm uppercase tracking-wide flex items-center gap-1.5 text-[#292524]">
